...
using JorJika.EventBus.RabbitMQ.WebApp2.IntegrationEvents.EventHandling;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IRabbitMQPersistentConnection>(sp =>
            {
                ...
                var factory = new ConnectionFactory() { HostName = "linux.jorjika.net" };
        ...
        {
            var subscriptionClientName = "WebApp2";
